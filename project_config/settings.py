...
# Media files (user-uploaded content such as book covers)
MEDIA_URL = '/media/'
...
# Redirect users to the book list after login/logout
LOGIN_REDIRECT_URL = 'core:book_list'
LOGOUT_REDIRECT_URL = 'core:book_list'
LOGIN_URL = 'login'
